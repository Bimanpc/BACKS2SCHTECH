...
<Window 
    ...
    <Grid>
        <Label Name="label" Content="Host" HorizontalAlignment="Left" Margin="38,84,0,0" VerticalAlignment="Top" Width="132"/>
        <Label Name="label1" Content="UserName" HorizontalAlignment="Left" Margin="38,115,0,0" VerticalAlignment="Top" Width="132"/>
